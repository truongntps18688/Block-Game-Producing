...
public class nrd : MonoBehaviour
{
    ...
    public static nrd Instance { get; private set; }
    private void Awake()
    {
        Instance = this;
    }
    ...
    // lấy tất cả stt tile cùng 1 sprite
    ...
    // truyền stt tile vào từ mảng để xử lý
    ...
    // set null
    //private void rutgon(int index, int x, int y)
    //{
    //    if (transform.GetChild(index + y).GetComponent<SpriteRenderer>().sprite == transform.GetChild(index - x + y).GetComponent<SpriteRenderer>().sprite)
    //    {
    //        transform.GetChild(index - x + y).GetComponent<SpriteRenderer>().sprite = null;
    //    }
    //    if (transform.GetChild(index + y).GetComponent<SpriteRenderer>().sprite == transform.GetChild(index + x + y).GetComponent<SpriteRenderer>().sprite)
    //    {
    //        transform.GetChild(index + x + y).GetComponent<SpriteRenderer>().sprite = null;
    ...
    //    sprite_(index);
    //}
    //private void rutgonElse(int index, int x, int y)
    //{
    //    transform.GetChild(index + x + y).GetComponent<SpriteRenderer>().sprite = null;
    //    transform.GetChild(index + 2*x + y).GetComponent<SpriteRenderer>().sprite = null;
    //}
    //private void spriteZ(int index)
    //{   
    //    if (transform.GetChild(index).GetComponent<SpriteRenderer>().sprite == transform.GetChild(index + 8).GetComponent<SpriteRenderer>().sprite)
    //    {
    //        if (transform.GetChild(index).GetComponent<SpriteRenderer>().sprite == transform.GetChild(index - 8).GetComponent<SpriteRenderer>().sprite)
    //        {
    //            rutgon(index, 16, 0);
    //        }
    //        else if(transform.GetChild(index).GetComponent<SpriteRenderer>().sprite == transform.GetChild(index + 16).GetComponent<SpriteRenderer>().sprite)
    //        {
    //            rutgonElse(index, 8, 0);
    //        }
    //        else
    //        {
    //            spriteXY(index);
    //        }
    //    }
    //    else if (transform.GetChild(index).GetComponent<SpriteRenderer>().sprite == transform.GetChild(index - 8).GetComponent<SpriteRenderer>().sprite)
    //    {
    //        if (transform.GetChild(index).GetComponent<SpriteRenderer>().sprite == transform.GetChild(index + 8).GetComponent<SpriteRenderer>().sprite)
    //        {
    //            rutgon(index, 16, 0);
    ...
    //    else if (transform.GetChild(index + 1).GetComponent<SpriteRenderer>().sprite == transform.GetChild(index + 8 + 1).GetComponent<SpriteRenderer>().sprite)
    //    {
    //        if (transform.GetChild(index + 1).GetComponent<SpriteRenderer>().sprite == transform.GetChild(index - 8 + 1).GetComponent<SpriteRenderer>().sprite)
    //        {
    //            rutgon(index, 16, 1);
    //        }
    //        else if (transform.GetChild(index + 1).GetComponent<SpriteRenderer>().sprite == transform.GetChild(index + 16 + 1).GetComponent<SpriteRenderer>().sprite)
    //        {
    //            rutgonElse(index, 8, 1);
    //        }
    //        else
    //        {
    //            spriteXY(index);
